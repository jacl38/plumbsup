...
public class TileController : MonoBehaviour
{
	...
	{
		if(Begin == Direction.NULL || End == Direction.NULL)
			return PipeType.BLOCK;
		
		else if((Begin == Direction.DOWN && End == Direction.UP) || (Begin == Direction.LEFT && End == Direction.RIGHT))
		{
	...
	void DoFill()
	{
		if(getType() != PipeType.BLOCK)
		{
			...
			if(Begin == End)
			{
				if(Begin == Direction.LEFT)
					End = Direction.RIGHT;
				else if(Begin == Direction.RIGHT)
					End = Direction.LEFT;
				else if(Begin == Direction.DOWN)
					End = Direction.UP;
				else if(Begin == Direction.UP)
					End = Direction.DOWN;
			}
			   ...
			   (Begin == Direction.RIGHT && End == Direction.LEFT))
			{
				...
				if(Begin == Direction.RIGHT && End == Direction.LEFT)
					gameObject.GetComponent<RectTransform>().rotation = Quaternion.Euler(0, 0, 90);
				if(Begin == Direction.UP && End == Direction.DOWN)
			...
			} else
			{
				   ...
				   (Begin == Direction.LEFT && End == Direction.UP))
				{
					if(Begin == Direction.DOWN && End == Direction.LEFT)
					{
						this.angle = Quaternion.Euler(0, 0, 0);
						gameObject.transform.rotation = angle;
					}
					if(Begin == Direction.RIGHT && End == Direction.DOWN)
					{
						this.angle = Quaternion.Euler(0, 0, 90);
						gameObject.transform.rotation = angle;
					}
					if(Begin == Direction.UP && End == Direction.RIGHT)
					{
						this.angle = Quaternion.Euler(0, 0, 180);
						gameObject.transform.rotation = angle;
					}
					if(Begin == Direction.LEFT && End == Direction.UP)
					{
						this.angle = Quaternion.Euler(0, 0, 270);
						gameObject.transform.rotation = angle;
					}
				...
				} else
				{
					...
					{
						this.angle = Quaternion.Euler(0, 0, 0);
						gameObject.GetComponent<RectTransform>().rotation = angle;
					}
		...
		{
			FillAmount = -1;
			Pipe.GetComponent<Image>().sprite = Block;
		}
	}
}